...
%% UPdate with language from Letizia et al 2023
...
%#TODO describe average flow fields?
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{figs/wake_center_advection_20240925.png}
%   \caption{Wake center trajectories for selected times. }
%   \label{fig:wakeCenterAdvection}
% \end{figure}

% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{figs/wake_center_kde_20240925.png}
%   \caption{Kernal density estiamtes of wake centers by distance downstream of the lidar. }
%   \label{fig:wakeCenterKDE}
% \end{figure}
